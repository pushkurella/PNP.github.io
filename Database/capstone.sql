...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2019 at 01:17 AM
...
('Fairview', 'Conestoga College - Door 3', 5, 3),
('Conestoga College - Rec Center', 'Fairview', 5, 3);
...
CREATE TABLE `files` (
  ...
  `downloads` varbinary(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'upload.zip', 2294, 0x32),
(2, 'file-upload-download.zip', 27075, 0x30),
(3, 'file-upload-download.zip', 27075, 0x30),
(4, 'file-upload-download.zip', 27075, 0x30),
(5, 'PHPInClassTask14.docx', 16200, 0x30),
(6, 'PHPInClassTask14.docx', 16200, 0x30),
(7, 'Assignment9_AB_Testing.docx', 19689, 0x30),
(8, 'PHPInClassTask14.docx', 16200, 0x30),
(9, 'logos (1).zip', 21413, 0x30),
(10, 'logos.zip', 21413, 0x30),
(11, 'logos.zip', 21413, 0x30),
(12, 'logos.zip', 21413, 0x30),
(13, 'logos.zip', 21413, 0x30);
...
(1, 'malhan', 'malhanachchhu@gmail.com', '12345'),
(2, 'riyanka', 'riyanka@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b');
